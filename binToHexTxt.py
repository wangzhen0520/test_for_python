...
def add_header_to_bin_file(input_file, output_file, header_data):
    # 定义头部结构
    # I: unsigned int (4 bytes), h: short (2 bytes), 10s: string of 10 bytes
    HEADER_FORMAT = '8sI'
...
def convert_bin_to_hex():
    ...
    bin_file_path = 'C:\\Users\\wangzhenk\\Downloads\\test.mp3'
    hex_file_path = 'C:\\Users\\wangzhenk\\Downloads\\test.mp3.txt'
    ...
    print(
        f'Bin file {bin_file_path} has been converted to Hex file {hex_file_path}')
